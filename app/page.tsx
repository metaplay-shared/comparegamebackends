      ...
      <section id="why-backend" className="container-page py-16 md:py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            ...
            <a href="https://sensortower.com/blog/state-of-mobile-gaming-2025" target="_blank" rel="noopener noreferrer" className="text-xs text-slate-400 hover:text-primary-600 mt-1 inline-block">
              Source: Sensor Tower 2025
            </a>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-primary-600 mb-2">64%</div>
            <p className="text-slate-600 dark:text-slate-400">
              of F2P game revenue generated by top 10% of paying players
            </p>
            <a href="https://www.gamedeveloper.com/business/report-whales-gobble-up-even-more-of-the-f2p-mobile-game-revenue-pie" target="_blank" rel="noopener noreferrer" className="text-xs text-slate-400 hover:text-primary-600 mt-1 inline-block">
          ...
          <div className="text-center">
            ...
            <a href="https://www.pocketgamer.biz/feature/66339/the-mobile-games-that-have-made-more-than-1-billion-in-lifetime-sales-update/" target="_blank" rel="noopener noreferrer" className="text-xs text-slate-400 hover:text-primary-600 mt-1 inline-block">
